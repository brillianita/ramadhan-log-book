...
<head>
    ...
    <style>
        ...
        .save-indicator.saving { background: #FFF3CD; color: #856404; display: block; }
        .save-indicator.saved { background: #D4EDDA; color: #155724; display: block; }
            ...
            <div class="page page-right">
                ...
                <div class="grid grid-cols-1 gap-6 mb-6">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                        ...
                        <div class="custom-checkbox">
                            <input type="checkbox" id="task1" data-task-id="1">
                            <label for="task1"><span></span>Sahur Bergizi (Walau sedikit)</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="task2" data-task-id="2">
                            <label for="task2"><span></span>Hydration (2 Gelas saat Sahur)</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="task3" data-task-id="3">
                            <label for="task3"><span></span>Lisan yang Cantik (No complaining)</label>
                        </div>
                    </div>
                    <!-- Section Hati -->
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                        ...
                        <div class="custom-checkbox">
                            <input type="checkbox" id="task4" data-task-id="4">
                            <label for="task4"><span></span>Luruskan Niat ("Nawaitu...")</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="task5" data-task-id="5">
                            <label for="task5"><span></span>Memaafkan Masa Lalu</label>
                        </div>
                        <div class="custom-checkbox">
                            <input type="checkbox" id="task6" data-task-id="6">
                            <label for="task6"><span></span>Mindful Moment (Nikmati lapar)</label>
                        </div>
                    </div>
                </div>
                <!-- Journaling Area -->
                <div class="flex-grow">
                    ...
                    <div class="mt-4 text-center">
                        <button id="saveJournalBtn" class="bg-sage hover:bg-[#7a8a4b] text-white font-sans-clean font-semibold px-6 py-2 rounded-lg transition duration-200 text-sm">
